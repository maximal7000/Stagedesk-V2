  ...
  // Wichtig: KEIN expliziter Default-Content-Type — axios wählt selbst:
  //   plain object → application/json
  //   FormData     → multipart/form-data; boundary=... (mit korrekter Boundary)
  // Ein expliziter Default würde die Boundary verschlucken und FormData-Uploads
  // beim Server in 400 enden, weil multipart nicht parsbar ist.
